...
public abstract class Assert {
	...
	public static void hasLength(String text, String message) {
		if (!StringUtil.hasValueBeforeTrim(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (StringUtil.hasValueBeforeTrim(textToSearch) && StringUtil.hasValueBeforeTrim(substring) &&
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new IllegalArgumentException(
					(StringUtil.hasValue(message) ? message + " " : "") +
	...
	public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
		...
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new IllegalArgumentException((StringUtil.hasValue(message) ? message + " " : "") +
