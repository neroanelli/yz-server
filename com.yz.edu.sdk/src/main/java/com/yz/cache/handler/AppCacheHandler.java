...
@Component(value =  CommonConstants.APP_CACHE_HANDLER)
public class AppCacheHandler extends BaseRedisCacheHandler {
	...
	public Object getCache(String redisName, String key, Class<?> cls) {
		String str = RedisService.getRedisService(redisName).hget(getCachePrefix(), key);
