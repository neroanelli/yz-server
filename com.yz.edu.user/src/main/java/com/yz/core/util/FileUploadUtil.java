...
public class FileUploadUtil {
	...
	public static boolean copyToDisplay(String oldFileSrc, String newFileSrc) {
		YzSysConfig sysParameterService= ApplicationContextUtil.getBean(YzSysConfig.class);
		String newBucket = sysParameterService.getBucket();
		String oldBucket = sysParameterService.getTempBucket();
	 ...
	 * @return
	 */
	public static boolean copyToDisplayDefault(String oldFileSrc, String newFileSrc) {
		YzSysConfig sysParameterService= ApplicationContextUtil.getBean(YzSysConfig.class);
		String newBucket = sysParameterService.getBucket();
		String oldBucket = sysParameterService.getBucket();
