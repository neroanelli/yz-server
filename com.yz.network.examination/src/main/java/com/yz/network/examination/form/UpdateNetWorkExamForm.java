 ...
 *
 */
@YzNetWorkForm(persistenceFrm = false, trigger = NetWorkExamFlowEnum.UN_INIT, handler = NetWorkExamConstants.UPDATE_NETWORKEXAMINATION_HANDLER
...
public class UpdateNetWorkExamForm extends BaseNetWorkExamForm {

	public UpdateNetWorkExamForm() {
		super();
		this.setNeedLogin(true);
		this.setName(UPDATE_NETWORK_EXAM_NAME);
	}

	public UpdateNetWorkExamForm(String id) {
		super(id);
		this.setNeedLogin(true);
		this.setName(UPDATE_NETWORK_EXAM_NAME);
	}
