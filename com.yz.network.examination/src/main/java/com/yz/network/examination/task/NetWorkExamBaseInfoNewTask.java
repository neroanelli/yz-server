 ...
 *
 **/
@Component(value = "netWorkExamBaseInfoNewTask")
public class NetWorkExamBaseInfoNewTask extends AbstractNetworkExamJob implements SimpleJob, NetWorkExamConstants {
	...
	public NetWorkExamBaseInfoNewTask() {
		setCorn("0/30 * * * * ?");
	...
	public void execute(ShardingContext shardingContext) {
		...
		PageHelper.startPage(shard, 50);
		List<Map<String, String>> list = netWorkExamFrmMapper.getSceneConfirmCollectAllStudent();
		list.forEach(p -> {
