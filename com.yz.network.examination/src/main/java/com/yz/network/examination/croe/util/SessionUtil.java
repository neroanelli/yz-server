...
import com.yz.network.examination.croe.constants.SecurityConstant;
...
public class SessionUtil {
	...
	public static LoginUser getUser() {
		...
		if (StringUtil.isNotBlank(sessionId))
			return RedisService.getRedisService().getByte(sessionId, LoginUser.class);
		return null;
	}
	...
	public static String pullToken(String groupId) {
		// MapCacheUtil map =
		// RemoteCacheUtilFactory.map(RequestUtil.getSessionId());
