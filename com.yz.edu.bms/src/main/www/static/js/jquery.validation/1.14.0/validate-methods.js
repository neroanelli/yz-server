/*******************************************************************************
 * jQuery Validate扩展验证方法 (linjq) Modified by guojunhui Date modified:01/01/2017
 ******************************************************************************/
$(function(){
    // 判断整数value是否等于0
    ...
    jQuery.validator.addMethod("isTel", function(value,element) {   
        var length = value.length;   
        var mobile = /^(((13[0-9]{1})|(14[0-9]{1})|(15[0-35-9]{1})|(17[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
        var tel = /^(\d{3,4}-?)?\d{7,9}$/g;       
	...
	// 考试成绩校验
	jQuery.validator.addMethod("isStdScore", function(value, element) {
		var reg = /^(?!0+(?:\.0+)?$)(?:[1-9]\d*|0)(?:\.\d{1})?$/;
		return this.optional(element) || (reg.test(value)); 
	},"请输入首位不为0，小数点位数不超过1位的数字");
	
	// 考试成绩校验
	jQuery.validator.addMethod("isStdFee", function(value, element) {
		var reg = /^(?:[1-9]\d*|0)(?:\.\d{1,2})?$/;
		return this.optional(element) || (reg.test(value)); 
	},"请输入首位不为0，小数点位数不超过2位的金额");
	
	// 考试成绩校验
	jQuery.validator.addMethod("datetime", function(value, element) {
		var reg = /^(\d{1,4})(-|\/)(\d{1,2})\2(\d{1,2}) (\d{1,2}):(\d{1,2}):(\d{1,2})$/;
		return this.optional(element) || (reg.test(value)); 
	},"日期格式不正确，请按yyyy-MM-dd HH:mm:ss的格式输入");
});
// 身份证号码的验证规则
