$(function(){
	_init_checkbox("goodsUse","goodsUse",dictJson["goodsUse"],varGoodsInfo.goodsUse);
	
	 var ueditorGoodsContent = UE.getEditor('goodsContent');
    ...
    ueditorGoodsContent.addListener("ready", function () {
        // editor准备好之后才可以使用
        if(varGoodsInfo.goodsContent !=null){
        	ueditorGoodsContent.setContent(varGoodsInfo.goodsContent);	
        }
    });
