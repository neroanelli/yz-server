var myDataTable;
            ...
            myDataTable = $('.table-sort').dataTable(
                {
                    ...
                    "columnDefs": [
                        ...
                        },
                        {
                            "render": function (data, type, row, meta) {
                                var dom = '';
                                dom += '<a class=" tableBtn normal" href="javascript:;" onclick="confirm_graduate(\'' + row.learnId + '\',\'' + row.stdName + '\',\'' + row.stdId + '\')">确认毕业</a>';
                                return dom;
                            },
                            "targets": 6
                        }
        ...
        function confirm_graduate(learnId, stdName, stdId) {
            var url = '/graduate/toGraduate.do' + '?learnId=' + learnId + '&stdName=' + stdName + '&stdId=' + stdId;
            layer_show(' 学员毕业', url, 1000, 510, function () {
