...
$(function() {
	...
	myDataTable = $('#dataListTable').dataTable(
			{
				"serverSide" : true,
				"dom" : 'rtilp',
				"ajax" : {
    ...
    function check_data(checkId,learnId,stdName,exType) {
      var url = '/check/checkData.do' + '?checkId=' + checkId+'&learnId='+learnId+'&stdName='+stdName+'&exType='+exType;
      layer_show('毕业资料核查', url, null, 500, function() {
