 var myDataTable;
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                "render": function (data, type,
                                    ...
                                    /* if('3' == status){
                                    	dom += '<a onclick="charges_excute(\'' + row.mtpId + '\')"><p class="c-blue">同步</p></a>';
                                    } */
                                    return dom;
                                },
                                "targets": 9
                            },
                            {
                                "render": function (data, type, row, meta) {
                                      return '<a class="tableBtn normal" onclick="toImport(\''+ row.mtpId + '\',\'CHECK\')">查看</a>';
                                },
                                "targets": 8	
                            },
                            {
                                "render": function (data, type, row, meta) {
                                    return _findDict("mtpStatus",row.mtpStatus);
                                },
                                "targets": 7
                            },
                            {
                                "render": function (data, type,
                                                    row, meta) {
                                    var dom = '';
                                    dom += row.checkUser + '<br>';
                                    var dateTime= row.checkTime;
                                    if(!dateTime){
                                        return '-'
                                    }
        ...
        function charges_excute(mtpId) {
            var url = '/msgPub/excuteTask.do' + '?mtpId='
                + mtpId;
