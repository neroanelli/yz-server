$(function(){
			...
			$("#checkStatus").change(function () {
				if($(this).val()=="2" && checkOrder=='1'){
				    $("#checkRemark").text("您的申请材料已正在受理，请耐心等候！")
				}else if($(this).val()=="2" && checkOrder=='2'){
                    $("#checkRemark").text("您的申请材料已受理。")
				}
				else if($(this).val()=="3"){
            ...
            var url = '/certificate/fdyCheck.do';
            if(applyType=='6'){
                url = '/certificate/fdyCheckZS.do';
			}
            if(checkOrder=='2'){
                url =  '/certificate/finalCheck.do';
                if(applyType=='6'){
                    url =  '/certificate/finalCheckZS.do';
                }
			}
